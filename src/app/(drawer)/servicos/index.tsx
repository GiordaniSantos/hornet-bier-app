        ...
        <View style={styles.container}>
          <View style={styles.card}>
            <View style={{padding:16}}>
              <View style={styles.header}>
                <View>
                  <Text style={styles.title}>Troca do Cooler 220v</Text>
                </View>
              </View>
              <Text style={styles.author}>Data de Criação: 18/12/2024</Text>
              <View style={styles.containerButtons}>
                <Link href="/servicos/edit/1234" style={styles.button} asChild>
          ...
          <View style={styles.card}>
            <View style={{padding:16}}>
              <View style={styles.header}>
                <View>
                  <Text style={styles.title}>Troca do Capacitor de Partida 127V</Text>
                </View>
              </View>
